const sampleListings = [
  ...
  },
  {
    ...
    geometry: {
      type: "Point",
      coordinates: [-86.8409, 21.1619], // Cancun approx
    },
    category: "Beach",
  },
  {
    ...
    geometry: {
      type: "Point",
      coordinates: [-120.0436, 39.0968], // Lake Tahoe approx
    },
    category: "Mountain",
  },
  {
  ...
  },
  {
    ...
    geometry: {
      type: "Point",
      coordinates: [7.2276, 46.0992], // Verbier approx
    },
    category: "Ice-Hills",
  },
  {
    ...
    geometry: {
      type: "Point",
      coordinates: [34.6857, -2.3333], // Serengeti approx (lon, lat)
    },
    category: "Resort",
  },
  {
  ...
  },
  {
    ...
    image: {
      filename: "listingimage",
      url:
        "https://images.unsplash.com/photo-1602088113235-229c19758e9f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8N3x8YmVhY2NoJTIwdmFjYXRpb258ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=800&q=60",
    },
    price: 1200,
    location: "Cotswolds",
    ...
    geometry: {
      type: "Point",
      coordinates: [-1.7840, 51.7680], // Cotswolds approx
    },
    category: "Peace-City",
  },
  {
  ...
  },
  {
    ...
    image: {
      filename: "listingimage",
      url:
        "https://plus.unsplash.com/premium_photo-1670963964797-942df1804579?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTZ8fGxvZGdlfGVufDB8MHx8MHx8fDA%3D&auto=format&fit=crop&w=800&q=60",
    },
    price: 1600,
    location: "Miami",
    country: "United States",
  ...
  },
  {
    ...
    geometry: {
      type: "Point",
      coordinates: [98.3963, 7.9519], // Phuket
    },
    category: "Beach",
  },
  {
    ...
    geometry: {
      type: "Point",
      coordinates: [-4.2026, 56.8169], // Scottish Highlands approx
    },
    category: "Archway",
  },
  {
  ...
  },
  {
    ...
    geometry: {
      type: "Point",
      coordinates: [-109.5337, 47.2850], // Montana approx
    },
    category: "Rooms",
  },
  {
    ...
    geometry: {
      type: "Point",
      coordinates: [25.3314, 37.4467], // Mykonos
    },
    category: "Beach",
  },
  {
    ...
    geometry: {
      type: "Point",
      coordinates: [-83.7534, 10.0150], // Costa Rica approx
    },
    category: "Forest",
  },
  {
  ...
  },
  {
    ...
    geometry: {
      type: "Point",
      coordinates: [-71.5724, 44.3106], // NH approx
    },
    category: "Mountain",
  },
  {
    ...
    geometry: {
      type: "Point",
      coordinates: [73.5361, 3.2028], // Maldives approx
    },
    category: "Resort",
  },
  {
    ...
    geometry: {
      type: "Point",
      coordinates: [-106.8175, 39.1911], // Aspen replicate
    },
    category: "Ice-Hills",
  },
  {
    ...
    geometry: {
      type: "Point",
      coordinates: [-84.3470, 9.7489], // Costa Rica approx
    },
    category: "Beach",
  },
  // — new entries you asked for:
  {
    title: "Historic Visit at the Taj Mahal",
    description:
      "Visit one of the world’s most iconic monuments, the Taj Mahal in India, and stay close to this marvel of architecture.",
    image: {
      filename: "listingimage",
      url: "https://res.cloudinary.com/debxc1fio/image/upload/v1762270200/LivHaven_DEV/nablk51imynyz8tgrtzu.webp",
    },
    price: 1300,
    location: "Agra",
    country: "India",
    geometry: {
      type: "Point",
      coordinates: [78.0421, 27.1750], // Taj Mahal approx: 78.0421E, 27.1750N :contentReference[oaicite:4]{index=4}
    },
    category: "World Icon",
  },
  {
    title: "Urban Experience in Surat",
    description:
      "Discover the vibrant city of Surat in Gujarat, India — commerce, culture, and city living in one place.",
    image: {
      filename: "listingimage",
    ...
    geometry: {
      type: "Point",
      coordinates: [72.8311, 21.1702], // Surat approx :contentReference[oaicite:5]{index=5}
    },
    category: "Rooms",
  },
  {
    title: "Hill-station Retreat in Saputara",
    description:
      "Relax in the scenic hill-station of Saputara, Gujarat, India — nature, forest, and quiet away from the city.",
    image: {
      filename: "listingimage",
      url: "https://res.cloudinary.com/debxc1fio/image/upload/v1762258494/LivHaven_DEV/m6pg7f0pvmtrwjbiu74k.jpg",
    },
    price: 900,
    location: "Saputara",
    country: "India",
    geometry: {
      type: "Point",
      coordinates: [73.7507, 20.5786], // Saputara approx :contentReference[oaicite:6]{index=6}
    },
    category: "Forest",
  },
  {
    title: "Adventure Stay in the Himalayas",
    description:
      "Experience majestic mountain stays in the heart of the Himalayas – the highest mountain range in the world.",
    image: {
      filename: "listingimage",
      url: "https://res.cloudinary.com/debxc1fio/image/upload/v1761065454/LivHaven_DEV/prtkcyxwdoadtlxylyii.jpg",
    },
    price: 2200,
    location: "Himalayas",
    country: "Nepal/India",
    geometry: {
      type: "Point",
      coordinates: [86.9253, 27.9881], // Himalayas centre approx: 86.9253E, 27.9881N :contentReference[oaicite:7]{index=7}
    },
    category: "Mountain",
  }
];
